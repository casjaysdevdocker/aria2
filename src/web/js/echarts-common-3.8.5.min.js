!(function (t, e) {
    ...
    jo(
      ...
      function (t, e) {
        ...
        d(t.newOption.series, function (t) {
          ...
          if (i) {
            var r = i.get('data');
            n.push({ name: t.name, data: Vu(t.data, r) });
  ...
  (Gu.prototype = {
    ...
    enableBrush: function (t) {
      return this._brushType && Hu(this), t.brushType && Wu(this, t), this;
    },
    ...
    updateCovers: function (t) {
      ...
      function r(e, n) {
        ...
        if (null != n && a[n] === h) s[e] = a[n];
          ...
          var r = (s[e] =
            null != n ? ((a[n].__brushOption = i), a[n]) : Zu(l, Fu(l, i)));
          ju(l, r);
        }
      }
      t = f(t, function (t) {
  ...
  var bw = {
      mousedown: function (t) {
        if (this._dragging) xc.call(this, t);
          ...
          (this._creatingCover = null),
            (this._creatingPanel = Yu(this, t, e)) &&
    ...
    Mw = {
      ...
      polygon: {
        createCover: function (t, e) {
          var n = new Tf();
          return n.add(new Fg({ name: 'main', style: oc(e), silent: !0 })), n;
        },
        getCreatingRange: function (t) {
          return t;
        },
          ...
          e.remove(e.childAt(0)),
            e.add(
              new Hg({
                ...
                draggable: !0,
                drift: lw(uc, t, e),
                ondragend: lw(Qu, t, { isEnd: !0 }),
              })
            );
        },
        updateCoverShape: function (t, e, n, i) {
          e.childAt(0).setShape({ points: dc(t, e, n) });
        },
        updateCommon: ic,
        contain: vc,
      },
  ...
  (Dw.setOutputRanges = function (t, e) {
        ...
        function (t) {
          ...
          if (((t.range = t.range || []), n && !0 !== n)) {
            ...
            var i = zw[t.brushType](0, n.coordSys, t.coordRange),
              r = t.__rangeOffset;
            t.range = r
              ? Ew[t.brushType](i.values, r.offset, Pc(i.xyMinMax, r.xyMinMax))
              : i.values;
          }
        },
        this
    ...
    (Dw.findTargetInfo = function (t, e) {
      for (
        var n = this._targetInfoList, i = Cc(e, t), r = 0;
        r < n.length;
        r++
      ) {
        var o = n[r],
  ...
  var Pw = {
        ...
        (n || i || r) &&
          ...
          o.each(function (t) {
            ...
            Iw(r.getCartesians(), function (t, e) {
              (Tw(n, t.getAxis('x').model) >= 0 ||
                Tw(i, t.getAxis('y').model) >= 0) &&
                o.push(t);
            }),
              e.push({
                panelId: 'grid--' + t.id,
    ...
    Nw = d,
    Bw = '\0_ec_hist_store';
  L_.extend({ type: 'dataZoom.select' }),
    O_.extend({ type: 'dataZoom.select' });
          ...
          null == o ||
            ...
            n(t, function (e, n) {
              if (null == o || 'all' == o || -1 !== l(o, n)) {
                var a = { type: 'select', $fromToolbox: !0, id: Gw + t + n };
                (a[r] = n), i.push(a);
              }
            });
        }
  ...
  (Hc.defaultOption = {
    ...
    (Hc.prototype.onclick = function (t, e, n) {
      Ec(t), e.dispatchAction({ type: 'restore', from: this.uid });
    }),
    Su('restore', Hc),
    jo(
  ...
  var Zw,
    Uw = 'urn:schemas-microsoft-com:vml',
    Xw = 'undefined' == typeof window ? null : window,
    jw = !1,
    qw = Xw && Xw.document;
  if (qw && !Md.canvasSupported)
    try {
      !qw.namespaces.zrvml && qw.namespaces.add('zrvml', Uw),
        (Zw = function (t) {
  ...
  if (!Md.canvasSupported) {
      ...
      gb = function (t, e, n, i) {
        ...
        null != n[e] && 'none' !== n[e] && (r || (!r && n.lineWidth))
          ? ((t[r ? 'filled' : 'stroked'] = 'true'),
            n[e] instanceof $g && lb(t, o),
            o || (o = Fc(e)),
            r ? fb(o, n, i) : pb(o, n),
            sb(t, o))
          : ((t[r ? 'filled' : 'stroked'] = 'false'), lb(t, o));
      },
      vb = [[], [], []],
      mb = function (t, e) {
        var n,
          ...
          switch (((r = p[o++]), (i = ''), (n = 0), r)) {
            ...
            case c:
              ...
              e &&
                ((b = e[4]),
                (M = e[5]),
                (S = Kw(e[0] * e[0] + e[1] * e[1])),
                (I = Kw(e[2] * e[2] + e[3] * e[3])),
    ...
    (Ue.prototype.brushVML = function (t) {
      ...
      if (r) {
        ...
        if (
          (this.transform &&
            ((x = this.transform),
            (b = Kw(x[0] * x[0] + x[1] * x[1])),
            (M = Kw(x[2] * x[2] + x[3] * x[3])),
            (w = x[1] || x[2])),
          w)
        ) {
          var S = [h, u],
        ...
        if (m) {
          ...
          L ||
            (((L = qw.createElement('div')).style.overflow = 'hidden'),
            (this._cropEl = L));
          var N = L.style;
          (N.width = $w((c + (g * c) / f) * b)),
    ...
    for (
      var Sb = new Zt(), Ib = [qf, Ze, Ue, ki, zg], Tb = 0;
      Tb < Ib.length;
      Tb++
    ) {
      ...
      (Ab.drawRectText = function (t, e, n, i) {
        ...
        if ((null != o && (o += ''), o)) {
          ...
          if ((m && !i && (Sb.copy(e), Sb.applyTransform(m), (e = Sb)), i))
            (c = e.x), (d = e.y);
          else {
            var y = r.textPosition,
              x = r.textDistance;
            if (y instanceof Array)
              (c = e.x + ub(y[0], e.width)),
          ...
          var w,
            ...
            I = this._textVmlEl;
          I
            ? (b = (w = (M = I.firstChild).nextSibling).nextSibling)
            : ((I = S('line')),
              (w = S('path')),
              (b = S('textpath')),
              (M = S('skew')),
          ...
          m && i
            ? (q(T, T, m),
              ...
              (M.matrix =
                ...
                m[3].toFixed(3) +
                ',0,0'),
              (M.offset = ($w(T[0]) || 0) + ',' + ($w(T[1]) || 0)),
              (M.origin = '0 0'),
              (A.left = '0px'),
              (A.top = '0px'))
            : ((M.on = !1), (A.left = $w(c) + 'px'), (A.top = $w(d) + 'px')),
            (b.string = ob(o));
          try {
            b.style.font = v;
          } catch (t) {}
          gb(I, 'fill', { fill: r.textFill, opacity: r.opacity }, this),
            gb(
              I,
              'stroke',
              {
  ...
  var Wb = {},
    ...
    Fb = function (t, e, n) {
      ...
      if (null != r) {
        ...
        var o = t.__textSvgEl;
        if (
          (o || ((o = qc('text')), (t.__textSvgEl = o)),
          nd(o, i, !0),
          t instanceof zg || t.style.transformText)
        )
          Jc(o, t.transform);
        else if (t.transform)
          Hb.copy(e), Hb.applyTransform(t.transform), (e = Hb);
        else {
        ...
        'left' === x
          ...
          : 'right' === x
          ? ((x = 'end'), v && (s -= v[1]))
          : 'center' === x && ((x = 'middle'), v && (s += (v[3] - v[1]) / 2));
        var _ = 0;
        if (
          ('baseline' === f
            ? ((_ = -n.height + p), v && (_ -= v[2]))
            : 'middle' === f
            ? ((_ = (-n.height + p) / 2), v && (l += (v[0] - v[2]) / 2))
            : v && (_ += v[0]),
              ...
              if (d || f) {
                if (
                  (!d || (f && h.newPos < u.newPos)
                    ? ((s = sd(u)), i.pushComponent(s.components, void 0, !0))
                    : ((s = h).newPos++,
                      i.pushComponent(s.components, !0, void 0)),
                  (c = i.extractCommon(s, e, t, n)),
                  s.newPos + 1 >= r && c + 1 >= o)
                )
                  return ad(0, s.components);
                l[n] = s;
              } else l[n] = void 0;
            }
            a++;
    ...
    (hd.prototype.markUsed = function (t) {
      if (t.style) {
        ...
        e && e._dom && ld.prototype.markUsed.call(this, e._dom),
          (e = t.style.stroke) &&
            e._dom &&
            ld.prototype.markUsed.call(this, e._dom);
      }
    }),
    h(ud, ld),
  ...
  (Xb.prototype = {
    ...
    _getDefs: function (t) {
      ...
      return 0 === n.length
        ? t
          ? ((n = e.insertBefore(qc('defs'), e.firstChild)).contains ||
              (n.contains = function (t) {
                var e = n.children;
                if (!e) return !1;
                for (var i = e.length - 1; i >= 0; --i)
